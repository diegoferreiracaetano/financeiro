	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->FormaPagamento->save($this->request->data)) {
				$this->Session->setFlash(__('The forma pagamento has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The forma pagamento could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->FormaPagamento->delete()) {
			$this->Session->setFlash(__('The forma pagamento has been deleted.'));
		} else {
			$this->Session->setFlash(__('The forma pagamento could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
